...
Full API digest: `GET /journal/help` on the same loopback base (returns markdown). Full spec: `docs/protocol.md` ("Journal search") in the matron-journal repo.
