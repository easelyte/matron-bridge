...
// the rest queued, `cancel` drops just the tapped message. A value missing from
// this set is refused as invalid — so an action added to the card in
...
const PICKER_OPTION_ID = /^(?:model|effort|mode|timer|perm|resume)-/;
