...
//   - Codex sessions: stripBridgeOnlySecrets only (see buildCodexSpawnEnv).
//
...
//
// Bridge-only secrets (HMAC_SECRET) are stripped: no Codex path uses them.
...
// stripping the token here would break tracker writes for them.
