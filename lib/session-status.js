...
// Mid-turn status repaint throttle (upstream): assistant events can arrive in
// bursts, so wall-clock gate the live-header repaint. True when no prior
// publish is recorded or the min interval has elapsed.
