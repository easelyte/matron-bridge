...
export function scopeFromToken(data) {
  ...
  // Field genuinely ABSENT: a token minted before pinned roots existed. It
  // keeps the old identity-free containment, and drains at its own expiry
  // (TOKEN_EXPIRY / LINK_EXPIRY_MS). Every current minter pins, so nothing
  // new enters this path.
