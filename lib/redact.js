...
function compilePythonPattern(source) {
  ...
  // The canonical credentials are ASCII-oriented. JavaScript shorthand
  // classes are ASCII while Python str-pattern shorthands include Unicode, so
  // non-ASCII additions remain a documented parity edge for future policy.
  // Reject only Python constructs that JavaScript would otherwise miscompile
  // instead of rejecting supported syntax.
