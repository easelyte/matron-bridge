...
// AUTHORIZATION: the HTTP header as curl -v / raw request dumps print it —
// `Authorization: Bearer <token>` — carries the whole credential as its value.
const SECRET_KEY_EXACT = /^(?:AUTH|AUTHORIZATION|SESSION|COOKIE)$/i;
