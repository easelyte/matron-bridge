...
export class TranscriptTail extends EventEmitter {
  ...
  async drain() {
    this._tick();
    // Recheck after one polling interval. This is an EOF acknowledgement, not
    // merely a request to read: an append racing the producer's exit metadata
    // is consumed before the promise resolves.
