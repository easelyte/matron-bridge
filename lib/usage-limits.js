...
// Parenthesis-less wording drift slugs the WHOLE suffix after "week" so
// distinct future weekly lines don't all collapse to "week_other" and collide:
...
export function deriveLimitId(rawLabel) {
  ...
  if (label.startsWith('week')) {
    ...
    const s = slug(label.slice('week'.length));
    return s ? `week_${s}` : 'week_other';
  }
