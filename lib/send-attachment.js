...
export function createSendAttachmentHandler({ sessions, publisher, journalConvoIdFor, rooms = null, onLocalRoomAttachment = null, maxBytes = MAX_ATTACHMENT_BYTES }) {
  return async function handleSendAttachment(data) {
    ...
    const { blob_ref, mime, name, size, isImage } = up.media;
